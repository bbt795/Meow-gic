...
public class Enemy : Entity
{
    ...
    private void OnCollisionEnter2D(Collision2D other)
    {
        ...
        if ((other.gameObject.CompareTag("Wall") || other.gameObject.CompareTag("Enemy") || other.gameObject.name == "DoorTop" || other.gameObject.name == "DoorBottom") && followPlayer == false)
        {
